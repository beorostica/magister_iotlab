...
var data = file.readFileSync('DATA_TOPOLOGY.txt', 'utf8');
...
var index_setup_m1    = data_agent_string.indexOf(';',0);
var index_setup_m2    = data_agent_string.indexOf(';',(index_setup_m1+1));
var index_setup_m3    = data_agent_string.indexOf(';',(index_setup_m2+1));
var neighbor_data_string = data_agent_string.substring(index_setup_m1+2,index_setup_m2-1);
